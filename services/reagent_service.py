...
def _clean_iupac(name: str | None) -> str | None:
    """
...
def _filter_solubility(raw: str | None) -> str | None:
    """
    ...
    for line in raw.split("\n"):
        # Strip "Water: " / "Other solvents: " prefix before parsing
...
def reagent_to_dict(reagent: Reagent) -> dict:
    ...
    return {
        ...
        "name_notations": {
            ...
            # PubChem stores multi-component IUPAC as semicolon-delimited
            # fragments (e.g. "iron(2+);sulfate") — not human-readable.
            "iupac":       _clean_iupac(reagent.iupac_name),
            "stock":       reagent.stock_name,
        },
        "synonyms":               (reagent.synonyms or [])[:_MAX_SYNONYMS],
        ...
        "solubility":             _filter_solubility(reagent.solubility),
